...
interface Article {
  ...
  published_at: string; // Nullable string (tanggal-waktu)
  created_at?: string; // Nullable string (ISO 8601 date-time)
  updated_at?: string; // Nullable string (ISO 8601 date-time)
}
