  ...
  <div class="space-y-8 pb-10">
    ...
    <div class="flex items-center flex-col gap-4">
      <div class="relative w-28 h-28">
        <img :src="avatarPreview || auth.user?.avatar_url || '/static/images/profile.png'" alt="Profile"
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-4">
          <div>
            ...
            <input id="name" v-model="form.name" type="text" class="form-input-custom" placeholder="Nama Lengkap Anda"
              required />
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input id="email" v-model="form.email" type="email" class="form-input-custom" placeholder="Email Anda"
                required />
            </div>
            <div>
          ...
          <div>
            ...
            <div
              class="flex items-center border border-gray-300 p-3 rounded-lg w-full focus-within:border-primary-600 focus-within:ring-1 focus-within:ring-primary-600 transition">
              <input id="password" type="password" class="bg-transparent outline-none w-full" placeholder="•••••••••••"
                readonly />
              <p class="text-primary-600 text-sm font-semibold cursor-pointer ml-3 whitespace-nowrap"
      ...
      <div class="space-y-4">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-2">Mengapa kami membutuhkan alamat Anda?
            <NuxtLink to="/faq-address" class="text-primary-600 underline hover:text-primary-700">Lihat di sini
            </NuxtLink>
          </p>
        </div>
