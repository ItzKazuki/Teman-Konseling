...
<template>
  <div class="space-y-8">
    ...
    <div class="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-4">
      <div v-for="(emotion, index) in emotions" :key="index"
        :class="[
        ...
        <Icon :name="`tk:emotion-${emotion.iconName}`" 
          class="w-3/5 h-3/5 object-contain mb-2 transition-transform duration-200"
          :class="[
        ...
        <p
          class="text-xs sm:text-sm font-semibold text-center transition-all duration-200"
